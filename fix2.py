...
replacements = {
    "test_combined_rules.py": [
        (r'assert j\["inspection"\] == 3\.0', 'assert j["inspection"] == 24.0'),
        (r'assert j\["calculated_total"\] == 9\.0', 'assert j["calculated_total"] == 30.0'),
        (r'assert z\["inspection"\] == 1\.0', 'assert z["inspection"] == 8.0'),
        (r'assert z\["calculated_total"\] == 1\.0', 'assert z["calculated_total"] == 8.0'),
        (r'assert no_ocs\["calculated_total"\] == 9\.0', 'assert no_ocs["calculated_total"] == 30.0'),
        (r'assert no_oth\["calculated_total"\] == 9\.0', 'assert no_oth["calculated_total"] == 30.0'),
        (r'assert ovr\["inspection"\] == 3\.0', 'assert ovr["inspection"] == 24.0'),
        (r'assert ovr\["calculated_total"\] == 29\.0', 'assert ovr["calculated_total"] == 50.0'),
    ],
    ...
    "test_phase11_lineage.py": [
        ...
        (r'assert b269\.inspection == 2\n', 'assert b269.inspection == 16\n')
    ],
    ...
    "test_review_workflow.py": [
        (r'assert updated\["J_FULL"\]\["inspection"\] == 32', 'assert updated["J_FULL"]["inspection"] == 32'),
        (r'assert updated\["J_FULL"\]\["calculated_total"\] == 38', 'assert updated["J_FULL"]["calculated_total"] == 59'),
